...
![User menu with sign out option](/docs/images/user-menu.png)
...
![Landing page with mode selection](/docs/images/landing-page.png)
...
![Transaction mode overview](/docs/images/transaction-mode.png)
...
![Yearly overview with all sections](/docs/images/yearly-overview.png)
...
![Copy Month modal](/docs/images/copy-month-modal.png)
...
![Clear Month modal](/docs/images/clear-month-modal.png)
